    ...
    switch(format) {
        ...
        case "KINESISOLD":
            ...
            promises = data.Records.map( (row, idx) => {
                ...
                // parsedData  = `{"data":[{"acc":107.025,"alt":0,"clientid":"012179919676","did":"Xits4L","dir":0,"ht":1506498669761,"lat":28.6251676,"lon":77.3735622,"pkid":"Xits4L1506498669737","projectid":"us-east-1_zI0af0OBy","prv":"android_fused","sensors":[{"type":"beacon", "uuid": "sssss","maj": 1,"min": 1,"dis": 1, "rssi": 1, "rng": 1, "temp":[55,77,88,99]}],"spd":0,"ts":1506498669737}]}`;
                // console.log(parsedData);return;
                try {
